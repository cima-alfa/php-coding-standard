 ...
 * }
 */
final class MethodArgumentSpaceFixer extends BaseFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    private function ensureFunctionFullyMultiline(Tokens $tokens, int $startFunctionIndex): void
    {
        ...
        if (null === $prevWhitespaceTokenIndex) {
            ...
            $lastLineIndex = mb_strrpos($existingIndentation, "\n");
            $existingIndentation = false === $lastLineIndex
                ? $existingIndentation
                : mb_substr($existingIndentation, $lastLineIndex + 1);
        }
